...
The maintainers who have been stewarding this project remain fully responsible for every line of code that ships. AI tools extend our capacity to review, research, and improve — they do not replace human judgment, expertise, or accountability.
...
AI tools help us process and understand incoming issues, pull requests, and code changes. This includes:
...
Releases are performed manually by the maintainers. The release process — including changelog review, version tagging, and publication — involves no AI-driven automation. Every release is initiated, supervised, and published by a human maintainer.
